...
HD_PWD='D:/VeriLogProjects/binary_graycode/binary_graycode.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log greycode.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source greycode.tcl -notrace
