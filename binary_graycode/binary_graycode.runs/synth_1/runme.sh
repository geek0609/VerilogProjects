...
HD_PWD='D:/VeriLogProjects/binary_graycode/binary_graycode.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log greycode.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source greycode.tcl
