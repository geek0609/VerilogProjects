...
HD_PWD='D:/VeriLogProjects/SerialInSerialOutBiDirectionalRegister/SerialInSerialOutBiDirectionalRegister.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SISOBDR.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SISOBDR.tcl
