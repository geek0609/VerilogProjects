...
// load program into memory 
	initial
	begin
	$readmemh("D:/VeriLogProjects/RISCVP/RISCVP.srcs/sim_1/new/program1.txt",instr_mem);
	end
...
// initialize data memory from file
	initial
	begin
	$readmemh("D:/VeriLogProjects/RISCVP/RISCVP.srcs/sim_1/new/data1.txt",data_mem);
	end
