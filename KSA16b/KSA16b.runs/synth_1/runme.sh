...
HD_PWD='D:/VeriLogProjects/KSA16b/KSA16b.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log kogge_stone_adder_16bit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source kogge_stone_adder_16bit.tcl
