...
HD_PWD='D:/VeriLogProjects/8bitripadd/8bitripadd.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log rca8.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source rca8.tcl
