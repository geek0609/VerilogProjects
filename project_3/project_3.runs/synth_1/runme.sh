...
HD_PWD='D:/VeriLogProjects/project_3/project_3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log andGaate.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source andGaate.tcl
