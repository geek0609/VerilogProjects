...
HD_PWD='D:/VeriLogProjects/KoggeStoneAdder8Bit/KoggeStoneAdder8Bit.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log kogge_stone_adder_8bit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source kogge_stone_adder_8bit.tcl
